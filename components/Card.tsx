...
export default function Card({ title, time, details, id, refs }: CardProps) {
  ...
  return (
    ...
    >
      <div className={`${flipped ? "hidden" : "block"}`}>
        ...
        <div className="flex justify-end mt-4">
          <div className="flex items-center">
            <span
              className={`opacity-${showSources ? "100" : "0"} mr-2 transition-opacity cursor-default`}
            >
              Show Sources
            </span>
            <button
      ...
      <div className={`${flipped ? "block" : "hidden"} rotate-y-180 text-left`}>
       <div>
